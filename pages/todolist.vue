        ...
        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
            ...
            >
                <div class="flex h-full flex-col pb-16">
                        ...
                        >
                            <div class="space-y-1">
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': selectedTab === '' }"
                                    @click="tabChanged('')"
                                >
                                ...
                                <button
                                    type="button"
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{ 'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': selectedTab === 'complete' }"
                                ...
                                <button
                                    type="button"
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{ 'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': selectedTab === 'important' }"
                                ...
                                <button
                                    type="button"
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{ 'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': selectedTab === 'trash' }"
                                ...
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 ltr:pl-3 rtl:pr-3 dark:bg-[#181F32]': selectedTab === 'team' }"
                                ...
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 ltr:pl-3 rtl:pr-3 dark:bg-[#181F32]': selectedTab === 'low' }"
                                ...
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 ltr:pl-3 rtl:pr-3 dark:bg-[#181F32]': selectedTab === 'medium' }"
                                ...
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 ltr:pl-3 rtl:pr-3 dark:bg-[#181F32]': selectedTab === 'high' }"
                                ...
                                <button
                                    ...
                                    :class="{ 'bg-gray-100 ltr:pl-3 rtl:pr-3 dark:bg-[#181F32]': selectedTab === 'update' }"
                    ...
                    <div class="absolute bottom-0 w-full p-4 ltr:left-0 rtl:right-0">
                        <button class="btn btn-primary w-full" type="button" @click="addTahrirlashTask()">
            ...
            <div class="panel h-full flex-1 overflow-auto p-0">
                <div class="flex h-full flex-col">
                                                                ...
                                                                >
                                                                    <a
                                                                        ...
                                                                        :class="{
                                                                            ...
                                                                            'bg-primary text-white': task.priority === 'medium' && isPriorityMenu === task.id,
                                                                            'bg-warning text-white': task.priority === 'low' && isPriorityMenu === task.id,
                                                                            'bg-danger text-white': task.priority === 'high' && isPriorityMenu === task.id,
                                                                        }"
                                                                    >
                                                                        {{ task.priority }}
                                                                    </a>
                                                                    <template #content="{ close }">
                                                                        <ul @click="close()" class="text-medium text-sm">
                                                                            <li>
                                                                                <button
                                                                                    type="button"
                                                                ...
                                                                >
                                                                    <a
                                                                        ...
                                                                        :class="{
                                                                            ...
                                                                            'bg-success text-white ': task.tag === 'team' && isTagMenu === task.id,
                                                                            'bg-info text-white ': task.tag === 'update' && isTagMenu === task.id,
                                                                        }"
                                                                    >
                                                                        {{ task.tag }}
                                                                    </a>
                                                                ...
                                                                <template #content="{ close }">
                                                                    <ul @click="close()" class="whitespace-nowrap">
                                                                        <template v-if="selectedTab !== 'trash'">
                                                                            <li>
                                                                                <a href="javascript:;" @click="addTahrirlashTask(task)">
                    ...
                    <template v-if="!pagedTasks.length">
                        <div class="flex h-full min-h-[400px] items-center justify-center text-lg font-semibold sm:min-h-[300px]">Ma'lumotlar yo'q</div>
                    </template>
                </div>
            </div>
                            ...
                            >
                                <DialogPanel class="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                    ...
                                    <div class="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5 dark:bg-[#121c2c]">
                                        {{ params.id ? 'Tahrirlash Task' : 'Add Task' }}
                                    </div>
                                    <div class="p-5">
                        ...
                        <div class="flex min-h-full items-center justify-center px-4 py-8">
                            ...
                            >
                                <DialogPanel class="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                    ...
                                    <div class="p-5">
                                        <div class="prose text-base" v-html="selectedTask.description"></div>
...
<script lang="ts" setup>
    ...
    const setPriority = (task: any, name: string = '') => {
        let item = filteredTasks.value.find((d: { id: any }) => d.id === task.id);
        item.priority = name;
        searchTasks(false);
    };
    ...
    const addTahrirlashTask = (task: any = null) => {
        isShowTaskMenu.value = false;
