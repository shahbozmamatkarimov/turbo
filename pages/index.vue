        ...
        <div class="pt-5">
            ...
            <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                <div class="panel h-full sm:col-span-2 xl:col-span-1">
                    ...
                    <div>
                        <client-only>
                            <apexchart height="160" :options="dailySales" :series="dailySalesSeries" class="overflow-hidden rounded-lg bg-white dark:bg-black">
                                <!-- loader -->
                                ...
                                <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0" class="align-middle">
                                    ...
                                    <template #content="{ close }">
                                        <ul @click="close()">
                                            ...
                                            <li>
                                                <a href="javascript:;">Tahrirlash Report</a>
                                            </li>
                                            <li>
                ...
                <div class="panel h-full p-0">
                    ...
                    <client-only>
                        <apexchart height="290" :options="totalOrders" :series="totalOrdersSeries" class="overflow-hidden rounded-lg bg-white dark:bg-black">
                            <!-- loader -->
                ...
                <div class="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
                    ...
                    <client-only>
                        <perfect-scrollbar
                            ...
                            class="relative mb-4 h-[290px] ltr:-mr-3 ltr:pr-3 rtl:-ml-3 rtl:pl-3"
                        >
                ...
                <div class="panel h-full w-full">
                    ...
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <tr>
                                    <th class="ltr:rounded-l-md rtl:rounded-r-md">Mijoz</th>
                                    <th>Mahsulot</th>
                                    <th>Chegirma</th>
                                    <th>Narx</th>
                            ...
                            <tbody>
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                    ...
                                    <td><NuxtLink to="/invoice/preview">#46894</NuxtLink></td>
                                    <td>$56.07</td>
                                ...
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                    ...
                                    <td><NuxtLink to="/invoice/preview">#76894</NuxtLink></td>
                                    <td>$126.04</td>
                                ...
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                    ...
                                    <td><NuxtLink to="/invoice/preview">#66894</NuxtLink></td>
                                    <td>$56.07</td>
                                    <td><span class="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span></td>
                                </tr>
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                    ...
                                    <td><NuxtLink to="/invoice/preview">#75844</NuxtLink></td>
                                    <td>$110.00</td>
                                    <td><span class="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Shipped</span></td>
                                </tr>
                                <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
