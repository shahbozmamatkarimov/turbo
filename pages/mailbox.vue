<template>
    <div>
        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
            ...
            ></div>
            <div
                class="panel dark:gray-50 absolute z-10 hidden h-full w-[250px] max-w-full flex-none space-y-3 overflow-hidden p-4 xl:relative xl:block xl:h-auto ltr:rounded-r-none ltr:xl:rounded-r-md rtl:rounded-l-none rtl:xl:rounded-l-md"
                        ...
                        >
                            <div class="space-y-1">
                                <button
                                    ...
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'inbox',
                                    }"
                                ...
                                <button
                                    ...
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'star',
                                    }"
                                ...
                                <button
                                    ...
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'sent_mail',
                                    }"
                                ...
                                <button
                                    ...
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'spam',
                                    }"
                                ...
                                <button
                                    ...
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'draft',
                                    }"
                                ...
                                <button
                                    ...
                                    class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-white-dark/10 hover:text-primary dark:hover:bg-[#181F32] dark:hover:text-primary"
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary': !isTahrirlash && selectedTab === 'trash',
                                    }"
                                ...
                                <disclosure as="div" v-slot="{ open }">
                                    ...
                                    >
                                        <icon-caret-down class="h-5 w-5 shrink-0" :class="{ 'rotate-180': open }" />
                                        ...
                                        <disclosure-panel as="ul" :unmount="false" class="mt-1 space-y-1">
                                                ...
                                                <button
                                                    ...
                                                    :class="{
                                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary':
                                                            !isTahrirlash && selectedTab === 'archive',
                                                    }"
                                            ...
                                            <li>
                                                <button
                                                    ...
                                                    :class="{
                                                        'bg-gray-100 text-primary dark:bg-[#181F32] dark:text-primary':
                                                            !isTahrirlash && selectedTab === 'important',
                                                    }"
            ...
            <div class="panel h-full flex-1 overflow-x-hidden p-0">
                <div v-show="!selectedMail && !isTahrirlash" class="flex h-full flex-col">
                    <div class="flex flex-wrap-reverse items-center justify-between gap-4 p-4">
                        <div class="flex w-full items-center sm:w-auto">
                            ...
                            <div class="ltr:mr-4 rtl:ml-4">
                                <client-only>
                                    <button type="button" v-tippy:refresh class="flex items-center hover:text-primary" @click="refreshMails()">
                                        <icon-refresh />
                                    </button>
                            ...
                            <template v-if="selectedTab != 'trash'">
                                <ul class="flex grow items-center gap-4 sm:flex-none ltr:sm:mr-4 rtl:sm:ml-4">
                                    <li>
                                        <div>
                                            <client-only>
                                                <button type="button" v-tippy:archive class="flex items-center hover:text-primary" @click="setArchive">
                                                    <icon-archive />
                                                </button>
                                    ...
                                    <li>
                                        <div @click="setSpam">
                                            <client-only>
                                                <button type="button" v-tippy:spam class="flex items-center hover:text-primary">
                                                    <icon-info-hexagon />
                                                </button>
                                    ...
                                    <li>
                                        <div class="dropdown">
                                            <client-only>
                                                ...
                                                >
                                                    <div>
                                                        <button type="button" v-tippy:group class="flex items-center hover:text-primary">
                                                            <icon-wheel />
                                                        </button>
                                        ...
                                        <div class="dropdown">
                                            <client-only>
                                                <Popper
                                                    ...
                                                    class="align-middle"
                                                >
                                                    <button type="button" class="flex items-center hover:text-primary">
                        ...
                        <div class="flex w-full items-center justify-between sm:w-auto">
                            <div class="flex items-center ltr:mr-4 rtl:ml-4">
                                <button type="button" class="block hover:text-primary xl:hidden ltr:mr-3 rtl:ml-3" @click="isShowMailMenu = !isShowMailMenu">
                                    <icon-menu />
                                </button>
                    ...
                    <div class="flex flex-col flex-wrap items-center justify-between px-4 pb-4 md:flex-row xl:w-auto">
                        <div class="mt-4 grid w-full grid-cols-2 gap-3 sm:w-auto sm:grid-cols-4">
                            ...
                            <button
                                ...
                                :class="{ 'bg-warning text-white': selectedTab === 'work' }"
                    ...
                    <template v-if="!pagedMails.length">
                        <div class="grid h-full min-h-[300px] place-content-center text-lg font-semibold">Ma'lumotlar yo'q</div>
                    </template>
                </div>
                <template v-if="selectedMail && !isTahrirlash">
                    <div>
                        <div class="flex flex-wrap items-center justify-between p-4">
                            <div class="flex items-center">
                                ...
                                <h4 class="text-base font-medium md:text-lg ltr:mr-2 rtl:ml-2">
                                    {{ selectedMail.title }}
                                </h4>
                            ...
                            <div class="flex flex-wrap">
                                <div class="flex-shrink-0 ltr:mr-2 rtl:ml-2">
                                    <img
                                        ...
                                        alt="avatar"
                                    />
                                    <div v-show="!selectedMail.path" class="rounded-full border border-gray-300 p-3 dark:border-gray-800">
                            ...
                            <div class="mt-8" v-show="selectedMail.attachments">
                                ...
                                <div class="mt-6 flex flex-wrap items-center">
                                    <template v-for="(attachment, i) in selectedMail.attachments" :key="i">
                                        <button
                                            type="button"
                                            class="group relative mb-4 flex items-center rounded-md border border-[#e0e6ed] px-4 py-2.5 transition-all duration-300 hover:border-primary hover:text-primary dark:border-[#1b2e4b] ltr:mr-4 rtl:ml-4"
                                        >
